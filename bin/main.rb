...
class Game
  ...
  def check_winner
    if ((active_board.cells[2][0] == active_board.cells[2][1]) && (active_board.cells[2][0] == active_board.cells[2][2]) && (active_board.cells[2][1] == active_board.cells[2][2]) && active_board.cells[2][0] != ' ' && active_board.cells[2][1] != ' ' && active_board.cells[2][2] != ' ')
      ...
      active_board.display_board_game
      game_over
    elsif ((active_board.cells[0][0] == active_board.cells[1][1]) && 
      (active_board.cells[0][0] == active_board.cells[2][2]) && (active_board.cells[1][1] == active_board.cells[2][2])
      && active_board.cells[1][1] != ' ' && active_board.cells[0][0] != ' ' && active_board.cells[2][2] != ' ')
      active_board.display_board_game
      game_over
    end
  end
